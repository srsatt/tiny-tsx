...
Test262 evidence is recorded per case. Nine complete cases currently execute as
...
programs, plus the direct string throw/catch and `Date.now()` type cases. Five
other allowlisted cases remain syntax-only and are not reported as semantic
