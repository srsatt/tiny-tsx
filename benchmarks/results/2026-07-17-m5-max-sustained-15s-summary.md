...
9.575–15.622 ms versus Bun at 0.821–1.683 ms. At concurrency 8, TinyTSX reaches
0.24x–0.46x Bun.
...
Repeated startup is close: TinyTSX is 20.99–22.86 ms and Bun is
...
returns from 68 peak descriptors to its baseline of 4. Bun also returns to its
workload baseline.
