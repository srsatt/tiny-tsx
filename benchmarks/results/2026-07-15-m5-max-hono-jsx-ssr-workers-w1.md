...
Generated: 2026-07-15T08:47:46+00:00
...
| --- | ---: | ---: | ---: | ---: | ---: |
| TinyTSX | 11.40 ms | 5.89 MiB | 6.05 MiB | 439.45 KiB | 439.45 KiB |
| Bun | 22.79 ms | 41.28 MiB | 98.66 MiB | 0.35 KiB | 60.15 MiB |
...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 10,013 | 9,220 | 1.09x | 0.094 ms | 0.098 ms | 0.113 ms | 0.139 ms |
| 8 | 32,155 | 33,768 | 0.95x | 0.232 ms | 0.225 ms | 0.304 ms | 0.402 ms |
| 32 | 31,330 | 31,653 | 0.99x | 0.933 ms | 0.910 ms | 1.142 ms | 1.147 ms |
| 64 | 31,522 | 29,879 | 1.06x | 1.916 ms | 1.827 ms | 2.373 ms | 7.576 ms |
...
- TinyTSX uses 1 fixed native worker(s) and always closes the connection.
