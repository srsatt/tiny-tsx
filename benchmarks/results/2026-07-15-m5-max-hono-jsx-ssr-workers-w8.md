...
Generated: 2026-07-15T08:49:49+00:00
...
| --- | ---: | ---: | ---: | ---: | ---: |
| TinyTSX | 7.15 ms | 6.03 MiB | 6.41 MiB | 439.45 KiB | 439.45 KiB |
| Bun | 20.56 ms | 41.39 MiB | 96.25 MiB | 0.35 KiB | 60.15 MiB |
...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 9,964 | 9,458 | 1.05x | 0.094 ms | 0.098 ms | 0.110 ms | 0.126 ms |
| 8 | 30,786 | 32,253 | 0.95x | 0.238 ms | 0.228 ms | 0.310 ms | 0.382 ms |
| 32 | 28,450 | 33,326 | 0.85x | 0.998 ms | 0.881 ms | 1.180 ms | 1.070 ms |
| 64 | 30,122 | 32,520 | 0.93x | 1.998 ms | 1.785 ms | 3.806 ms | 2.196 ms |
...
- TinyTSX uses 8 fixed native worker(s) and always closes the connection.
