...
The implemented benchmark compares the current static TinyTSX vertical slice to
an idiomatic `Bun.serve` server returning the same response. It verifies status,
content type, content length, and response bytes before collecting samples.
